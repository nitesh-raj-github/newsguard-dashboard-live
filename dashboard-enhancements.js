(() => {
  ...
  @media(max-width:980px){.analyze-grid{grid-template-columns:1fr}.analyze-side{grid-template-columns:repeat(3,1fr)}.scan-card{padding:14px}}@media(max-width:780px){.side{display:block;padding:16px 14px}.mobile{display:none}.nav,.nav.open{display:flex;position:static;overflow-x:auto;gap:6px;padding:15px 0 2px;background:transparent;border:0}.nav button{width:auto;white-space:nowrap;padding:9px 10px}.side-foot{display:none}.analyze-side{grid-template-columns:1fr}.site-footer{align-items:flex-start;flex-direction:column}.home-hero{padding:25px}}
  `;
